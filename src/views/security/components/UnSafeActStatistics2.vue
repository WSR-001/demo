<template>
  <div id="UnSafeActStatistics2" style="width:100%;height: 200px;"></div>
</template>

<script>
  import echarts from 'echarts';
  export default {
    name: 'UnSafeActStatistics2',
    props:["activeName"],
    data() {
      return {
        num:[],
    ...
    methods: {
      draw(){
        const myEcharts = echarts.init(document.getElementById('UnSafeActStatistics2'));
